...
- Dual Language Support / 双语切换 — Freely switch between Chinese and English｜全站中英文一键切换，适配双语使用场景
...
- Agent Module (Red glow)｜英雄模块（红色流光）
- Full Weapon Module (Amber glow)｜全武器模块（琥珀流光）
...
├── agents/          # Agent image assets 英雄素材文件夹
├── weapons/         # Weapon & melee knife image assets 武器、近战刀素材文件夹

🚀 How to Use | 使用教程
1. EN: Download all project files｜下载全部项目文件
2. EN: Placeagents/ and weapons/ folders in the same directory asindex.html｜将素材文件夹与主文件放在同一目录
3. EN: Open index.html with any modern browser｜使用任意现代浏览器直接打开网页
4. EN: Switch Chinese / English via the top-right button｜右上角按钮切换双语模式
5. EN: Turn sound on/off via the bottom-right button｜右下角按钮开关音效
🛠 Tech Stack | 技术栈
- HTML5 — Page structure 页面结构
- Tailwind CSS — Responsive modern styling 自适应样式框架
- Font Awesome — Icon system 图标库
- Vanilla JavaScript — Animation, random logic, i18n & audio system 原生JS实现动画、随机算法、双语、音效系统

📄 License | 开源协议
EN: Free for personal use & study. No commercial use without permission.
中文: 项目仅供个人学习、娱乐免费使用，未经授权禁止商用。
